...
import { ArrowLeft, Save, Eye, EyeOff, Sparkles, Settings, AlertCircle, User, Edit3, Plus, X } from 'lucide-react';
...
const AICoachSettings: React.FC = () => {
  ...
  const [apiKey, setApiKey] = useState(deepSeekApiKey || 'sk-0834a814d7dd43049b8f2757f3f3554f');
          ...
          <div className="bg-white rounded-lg p-4 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-bold text-gray-900">{aiCoach.name}</h2>
                  <p className="text-sm text-gray-600">
                    {customIdentity.role || (aiCoach.personality === 'strict' ? '严格型教练' : 
            ...
            {customIdentity.description && (
              <p className="text-sm text-gray-600 mb-3">{customIdentity.description}</p>
            )}
